...
const Nav = () => {
  ...
  return (
    ...
    <div>
    <ul className="relative col-span-2 flex justify-start gap-6 lg:col-span-5 text-black">
          <li>
            <a
              href="#"
              rel="noreferrer"
      ...
      <div className='py-5 flex justify-center border border-t border-b'>
        <img src="/flexGlobalLogoVertical.svg" alt="flexGlobalLogoVertical" width={200} height={200}/>
      </div>
      ...
      <div className="max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto p-4">
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="text-white flex gap-x-3 items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
