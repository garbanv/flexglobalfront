    ...
    <nav className="bg-white  dark:bg-gray-900  w-full z-20 top-0  ">
      ...
      <div className="max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto px-5 md:px-0 md:py-4">
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="text-white flex gap-x-3 items-center bg-[#BC9B5F] hover:bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:px-4 py-2 text-center transition-all duration-500"
          >
